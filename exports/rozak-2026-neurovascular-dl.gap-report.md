...
**Paper:** `rozak-2026-neurovascular-dl` · **Claims registered:** 2026-03-30 – 2026-09-10
...
**73 of 129 relations (57%) have no MIRA predicate and are absent from the strict export.**
...
**19 verification records across 19 claims are absent from the strict export.** MIRA has no node type for the fact that a claim was independently checked, by what code, against what data, with what result. They are carried in the extended file as `cg:VerificationRecord`.
