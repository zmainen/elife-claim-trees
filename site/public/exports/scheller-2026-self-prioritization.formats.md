...
- `cg:requires` (15) — a claim depends on another holding
- `cg:scopes` (14) — a scope constraint governs another claim's validity
- `cg:interprets` (10) — one claim interprets another
