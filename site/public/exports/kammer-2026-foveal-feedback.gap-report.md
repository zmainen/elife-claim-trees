...
**41 of 66 relations (62%) have no MIRA predicate and are absent from the strict export.**
...
| `dissociates-with` | 2 | the source and target jointly establish a dissociation — two claims whose difference across a condition, region, population or measure is itself the finding, neither bearing on the other's truth (symmetric) |
