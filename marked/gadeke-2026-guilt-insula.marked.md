...
Selecting the safe option led to both players receiving an equal outcome. === Figure 2 === Figure 2. Participant choices in Studies 1 (outside fMRI, N = 40) and 2 (inside fMRI, N = 44).⟦>zach claim=37937db1-e635-46d4-ac0a-f482400668e5: @{Selecting the safe option led to both players receiving an equal outcome. === Figure 2 === Figure 2. Participant choices in Studies 1 (outside fMRI, N = 40) and 2 (inside fMRI, N = 44).} findings-rest-two-samples-healthy⟧
...
[panels detected: a, d, b, e, c, f] === Figure 3 === Figure 3. Participant momentary happiness in Studies 1 ( A–D ) and 2 ( E–H ).⟦>zach claim=a246d73e-44f4-4bee-aff2-96388949b76a: @{[panels detected: a, d, b, e, c, f] === Figure 3 === Figure 3. Participant momentary happiness in Studies 1 ( A–D ) and 2 ( E–H ).} participant-momentary-happiness-varied-rewards-2⟧
...
Each coloured dot is one recovered parameter value; different colours represent different participants. === Figure 4 === Figure 4. BOLD responses.⟦>zach claim=8eccf358-8cda-4fec-b608-34581e8afbe7: @{Each coloured dot is one recovered parameter value; different colours represent different participants. === Figure 4 === Figure 4. BOLD responses.} bilateral-ventral-striatum-more-active⟧
...
All coefficients and differences reported are significantly different from 0 (see Appendix 1—table 4 ).⟦>zach claim=no-assertion: @{All coefficients and differences reported are significantly different from 0 (see Appendix 1—table 4 ).} A pointer to Appendix 1—table 4 rather than a result stated in the caption.⟧
...
All coefficients and differences reported are significantly different from 0 (see Appendix 1—table 6 ).⟦>zach claim=no-assertion: @{All coefficients and differences reported are significantly different from 0 (see Appendix 1—table 6 ).} A pointer to Appendix 1—table 6 rather than a result stated in the caption.⟧
...
[panels detected: a, b, c, d, e, f, g, h, i] === Figure 5 === Figure 5. Changes in functional connectivity between the left anterior insula (seed) and a cluster in the right inferior frontal gyrus at the time of the choice as a function of condition (Social vs. Solo) and choice (Risky or Safe).⟦>zach claim=5d2ef557-c6ec-4052-82c2-0b8e4c297e01: @{[panels detected: a, b, c, d, e, f, g, h, i] === Figure 5 === Figure 5. Changes in functional connectivity between the left anterior insula (seed) and a cluster in the right inferior frontal gyrus at the time of the choice as a function of condition (Social vs. Solo) and choice (Risky or Safe).} functional-connectivity-between-left-anterior⟧

In the righthand panel, dots are data of individual participants, the markers represent means, and error bars indicate 95 confidence intervals about the mean. === Figure 5s1 === Figure 5—figure supplement 1. Functional connectivity with the left TD-model-defined superior temporal sulcus (STS; seed) during choices in Solo and Social conditions.⟦>zach claim=no-assertion: @{In the righthand panel, dots are data of individual participants, the markers represent means, and error bars indicate 95 confidence intervals about the mean. === Figure 5s1 === Figure 5—figure supplement 1. Functional connectivity with the left TD-model-defined superior temporal sulcus (STS; seed) during choices in Solo and Social conditions.} Explains what dots, markers and error bars encode; a graphical-encoding note, not a finding.⟧

Connectivity between the left STS (seed) and a cluster in the left inferior frontal gyrus that did not survive corrections for multiple tests, where connectivity with the left STS (the seed region) showed the opposite pattern: connectivity was highest when participants made Safe choices for themselves and Risky choices for both players (p uncorrected = 0.001, T = 4.44, Z = 4.30, 35 voxels, peak at MNI [–48 14 6]).⟦>zach claim=c6a31726-78b5-45f6-861c-b2a3b8ac3249: @{Connectivity between the left STS (seed) and a cluster in the left inferior frontal gyrus that did not survive corrections for multiple tests, where connectivity with the left STS (the seed region) showed the opposite pattern: connectivity was highest when participants made Safe choices for themselves and Risky choices for both players (p uncorrected = 0.001, T = 4.44, Z = 4.30, 35 voxels, peak at MNI [–48 14 6]).} left-ifg-cluster-showed-opposite — The STS-seed to left-IFG connectivity with the opposite pattern that did not survive correction is exactly what the claim records.⟧
