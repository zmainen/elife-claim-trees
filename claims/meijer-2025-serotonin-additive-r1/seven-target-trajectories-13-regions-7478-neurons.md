---
uuid: 444c03ce-bd5a-40db-9bdf-f3325b935ce0
...
displayClaim: >
  Recording dataset: 7,478 neurons, 13 regions, 86 insertions, 57 sessions, 17 mice
  (11 SERT, 6 WT) — IBL pipeline sorted, histology-aligned, awake head-fixed.
...
Carries over from v1 with one expansion: now also scopes the new R1 GLM claims (`near-zero-choice-by-stim-interaction`, `glm-significant-choice-and-5ht-coefficients`). The 13-region coverage is not exhaustive of the forebrain, and the t-test for the GLM interaction term (n = 10) is at the typical scale for this class of experiment but is small for hierarchical mixed-effects analysis at the per-animal level. Generalizations of the brain-wide additivity finding to non-recorded regions require the additional assumption of homogeneity that the data do not directly support.
