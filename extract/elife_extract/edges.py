...
# provenance record, and an output nobody can trace to its prompt is not reproducible.
EDGE_PROMPT = (Path(__file__).parent.parent / "prompts" / "edge-inference.md").read_text(
    encoding="utf-8")
